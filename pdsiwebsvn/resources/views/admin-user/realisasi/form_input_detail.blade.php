    ...
    <div class="tab-pane fade active in" role="tabpanel" id="home" aria-labelledby="home-tab">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-6">
                    ...
                    <input type="text"  disabled="true" maxlength="400" class="form-control" id="routingslip_no"  name="routingslip_no" value="{{ $row==""?"":$row->routingslip_no }}" data-error="tess"     >
                </div>
            </div>
            <div class="form-group row">
                                    ...
                                    <td><div class="autocomplete" style="width:300px;">
                                       ...
                                       <td><input type="text" size="2" id="m1_qty" name="qty[]" onblur="jshitung(this);"></td> 
                                        ...
                                        <td><input type="text" size="2" readonly id="m1_total" name="total[]"> 
                                            <i onclick="jsdel(this);" id="m1_del" class="fa fa-trash"></i></td>
