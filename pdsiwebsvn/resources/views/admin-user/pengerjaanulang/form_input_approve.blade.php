...
<form id="form1" enctype="multipart/form-data"  class="form1" method="post" action="{{ URL::to('/').'/admin-user/pengerjaanulang-store-approve' }}">
                {{ csrf_field() }}
    ...
    <div class="tab-pane fade active in" role="tabpanel" id="home" aria-labelledby="home-tab">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-6">
                    ...
                    <input type="date" readonly maxlength="400" class="form-control" id="nama_kelas" name="tanggal" value="{{ $row==""?date('Y-m-d'):date('Y-m-d',strtotime($row->ispeksi_test_tgl)) }}" data-error="tess"  >
                </div>
            </div>
            ...
            <div class="form-group row">
                <label  for="inputName" class="col-sm-3 col-form-label text-left">Kerja Ulang</label>

            
                <div class="col-sm-3">
                <select name="routingslip_status_desc_ku">
                    <?php
                    $st= explode("-", $row->routingslip_status_desc_ku);
                    ?>
                ...
                <div class="col-sm-6">
                    <input type="text" maxlength="400" class="form-control" id="nama_kelas" name="keterangan_ku" value="{{ $row->keterangan_ku }}" placeholder="keterangan" >
                </div>
...
<div class="form-group">
    ...
    <button type="button" onclick="window.open('/admin-user/pengerjaanulang-list/1','_self')" class="btn btn-primary waves-effect waves-light" ><i class="fa fa-rotate-left" aria-hidden="true"></i></button>
