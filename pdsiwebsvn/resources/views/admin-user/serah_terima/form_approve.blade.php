...
<div class="form-group row" style="background-color: orange;padding: 20px;border-radius: 5px;" >
    <label  for="inputName" class="col-sm-3 col-form-label text-left">
        Status Approve
        
    </label>
    <div class="col-sm-3">
    <select name="appserahterima">
    ...
    <div class="col-sm-6">
        <input type="text" maxlength="400" class="form-control" id="nama_kelas" name="appserahterimaket" placeholder="keterangan" value="{{ $ket1 }}" >
    </div>
</div>
...
<div class="form-group row" style="background-color: orange;padding: 20px;border-radius: 5px;" >
    ...
    <div class="col-sm-6">
        <input type="text" maxlength="400" class="form-control" id="nama_kelas" name="approutingket" placeholder="keterangan" value="{{ $ket2 }}" >
    </div>
</div>
...
<div class="form-group row" style="background-color: orange;padding: 20px;border-radius: 5px;" >
    ...
    <div class="col-sm-6">
        <input type="text" maxlength="400" class="form-control" id="nama_kelas" name="appregisterket" placeholder="keterangan" value="{{ $ket3 }}" >
    </div>
</div>
