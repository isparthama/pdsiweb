...
class Tools extends Controller
{
    ...
    {
        $sql="select * from m_wo_tools";
        $data['listdata']=DB::select($sql);
        $data['content']="admin-user.tools.list_form";
        $data['judul']="List Tools";
        ...
        Session::put('mail','');
        Session::put('tools','class="current"');
    ...
    {
        $data['row']="";
        $data['content']="admin-user.tools.form_input";
        $data['judul']="Form Tools";
    ...
    {
        $data['row']=ModelTools::where('id',$id)->first();
        $data['content']="admin-user.tools.form_input";
    ...
    {
        ModelTools::where('id',$id)->delete();
        Session::put('alert-success','Data Berhasil Dihapus');
        return redirect('/admin-user/tools-list/');
    }
}
