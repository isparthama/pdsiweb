    ...
    <div class="tab-pane fade active in" role="tabpanel" id="home" aria-labelledby="home-tab">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-6">
                    ...
                    <input type="date" maxlength="400" class="form-control" id="nama_kelas" name="tanggal" value="{{ $row==""?date('Y-m-d'):($row->form_tanggal==""?date('Y-m-d'):date('Y-m-d',strtotime($row->form_tanggal))) }}" data-error="tess"  >
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6 col-xs-12">
                        ...
                        <a target="blank" href="{{ URL::to('/') }}{{ $row->dim_filename }}" ><i style="font-size:20px;" class="fa fa-image"></i> {{ $row->dim_filename }}</a>
                            <br><input type="file" name="dim_filename"  />
                        @else
                            <input type="file" name="dim_filename" />
                        @endif
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6 col-xs-12">
                        ...
                        <a target="blank" href="{{ URL::to('/') }}{{ $row->vis_filename }}" ><i style="font-size:20px;" class="fa fa-image"></i> {{ $row->vis_filename }}</a>
                            <br><input type="file" name="vis_filename"  />
                        @else
                            <input type="file" name="vis_filename" />
                        @endif
...
//            
        ...
        function jsadd(x,jns){
            ...
            if(jns==1){
                n=$('#'+x+' tr').length;
                $('#'+x+' tr:last').after('<tr><td><div class="autocomplete" style="width:300px;"><input type="text" name="nama[]" size="18" id="m'+n+'"  onkeypress="jscaridt(this);" ></div></td><td><input type="hidden" value="1" size="2" name="jns[]" id="m'+n+'_jns"><input type="text" onblur="jshitung(this);" name="pn[]" size="2" id="m'+n+'_pn"></td><td><input type="text" name="qty[]" size="2" id="m'+n+'_qty" onblur="jshitung(this);"></td><td><input type="hidden" name="id[]" size="2" readonly id="m'+n+'_id"><input type="text" name="satuan[]" size="2"  id="m'+n+'_satuan"></td><td><input type="text" size="2" onblur="jshitung(this);" name="harga[]" id="m'+n+'_harga"></td><td><input type="text" size="2" name="total[]" readonly id="m'+n+'_total">  <i onclick="jsdel(this);" id="m'+n+'_del" class="fa fa-trash"></i></td></tr>');
            }
            if(jns==2){
                n=$('#'+x+' tr').length;
                $('#'+x+' tr:last').after('<tr><td><div class="autocomplete" style="width:300px;"><input type="text" name="tnama[]" size="18" id="t'+n+'"  onkeypress="jscaridt(this);" ></div></td><td><input type="hidden" value="2" size="2" name="tjns[]" id="t'+n+'_jns"><input type="text" onblur="jshitung(this);" name="tpn[]" size="2" id="t'+n+'_pn"></td><td><input type="text" name="tqty[]" size="2" id="t'+n+'_qty" onblur="jshitung(this);"></td><td><input type="hidden" name="tid[]" size="2" readonly id="t'+n+'_id"><input type="text" name="tsatuan[]" size="2"  id="t'+n+'_satuan"></td><td><input type="text" onblur="jshitung(this);" size="2" name="tharga[]" id="t'+n+'_harga"></td><td><input type="text" size="2" name="ttotal[]" readonly id="t'+n+'_total">  <i onclick="jsdel(this);" id="t'+n+'_del" class="fa fa-trash"></i></td></tr>');
            }
            if(jns==3){
                n=$('#'+x+' tr').length;
                $('#'+x+' tr:last').after('<tr><td><div class="autocomplete" style="width:300px;"><input type="text" name="pnama[]" size="18" id="p'+n+'"  onkeypress="jscaridt(this);" ></div></td><td><input type="hidden" value="3" size="2" name="pjns[]" id="p'+n+'_jns"><input type="text" onblur="jshitung(this);" name="ppn[]" size="10" id="p'+n+'_pn"></td><td><input type="text" name="pqty[]" size="2" id="p'+n+'_qty" onblur="jshitung(this);"></td><td><input type="hidden" name="pid[]" size="2" readonly id="p'+n+'_id"><input type="text" name="psatuan[]" size="2"  id="p'+n+'_satuan"></td><td><input type="text" onblur="jshitung(this);" size="2" name="pharga[]" id="p'+n+'_harga"></td><td><input type="text" size="2" name="ptotal[]" readonly id="p'+n+'_total">  <i onclick="jsdel(this);" id="p'+n+'_del" class="fa fa-trash"></i></td></tr>');
            }
            if(jns==4){
                n=$('#'+x+' tr').length;
                $('#'+x+' tr:last').after('<tr><td><div class="autocomplete" style="width:300px;"><input type="text" name="rnama[]" size="18" id="r'+n+'"  onkeypress="jscaridt(this);" ></div></td><td><input type="hidden" value="4" size="2" name="rjns[]" id="r'+n+'_jns"><input type="text" onblur="jshitung(this);" name="rpn[]" size="2" id="r'+n+'_pn"></td><td><input type="text" name="rqty[]" size="2" id="r'+n+'_qty" onblur="jshitung(this);"></td><td><input type="hidden" name="rid[]" size="2" readonly id="r'+n+'_id"><input type="text" name="rsatuan[]" size="2"  id="r'+n+'_satuan"></td><td><input type="text" onblur="jshitung(this);" size="2" name="rharga[]" id="r'+n+'_harga"></td><td><input type="text" size="2" name="rtotal[]" readonly id="r'+n+'_total">  <i onclick="jsdel(this);" id="r'+n+'_del" class="fa fa-trash"></i></td></tr>');
            }
        ...
        function jshitung(id){
            ...
            $.post("{{ URL::to('/') }}/admin-user/save-material-produksi", param,function(data){
                jstotal();
            });
                                ...
                                <tr>
                                    <td><div class="autocomplete" style="width:300px;">
                                       ...
                                       <td><input type="hidden" value="3" size="2" name="pjns[]" id="p<?php echo $personil->baris_no;?>_jns">
                                           <input type="text" size="10" name="ppn[]"  value="<?php echo $personil->keterangan_tambahan;?>" id="p<?php echo $personil->baris_no;?>_pn"></td> 
                                       <td><input type="text" size="2" id="p<?php echo $personil->baris_no;?>_qty" name="pqty[]" value="<?php echo $personil->estimasi_jumlah;?>"  onblur="jshitung(this);"></td> 
                                        ...
                                        <td><input type="text" size="2" readonly id="p<?php echo $personil->baris_no;?>_total" value="<?php echo $personil->estimasi_harga_total;?>"  name="ptotal[]"> 
                                            <i onclick="jsdel(this);" <?php echo $tools->baris_no;?> id="p<?php echo $personil->baris_no;?>_del" class="fa fa-trash"></i></td>
...
<div class="form-group row">
    ...
    <div class="col-sm-6">
        <input type="text" readonly style="background-color: #e9e9e9;"  maxlength="400" class="form-control" id="estimasi_biaya" name="estimasi_biaya" value="" data-error="tess"    >
    </div>
</div>
