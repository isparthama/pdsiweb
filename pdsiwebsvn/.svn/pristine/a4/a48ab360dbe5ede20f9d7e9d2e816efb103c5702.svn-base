...
<div class="row">
    <div class="col-md-12">
        <form method="POST" action="{{ route('output.save') }}">
            {{ csrf_field() }}
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <strong>Nama </strong>
                        <input type="text" maxlength="100" class="form-control" id="fullname" name="name" value="" placeholder=""  required>
                        </div>
                    </div> <!-- End Col -->
                    <div class="col-md-6">
                        <div class="form-group">
                            <br/>
                            <!-- /.switch -->
                            <div class="switch success"><input type="checkbox" name="active" class="form-control" checked id="switch-3"><label for="switch-3">Active</label></div>
                        </div>
                    </div>
                </div>
                <div class="form-group">
