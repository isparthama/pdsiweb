            ...
            @foreach($listdata as $data)
                <tr>
                        ...
                        <td>
                            ...
                            <a <?php echo $data->form_sts_desc=='1-Approve' || $data->form_sts_desc=='4-Procurement'?" style='display:none;' ":"";?> href="{{ URL::to('/') }}/admin-user/edit-produksi/{{ $data->routingslip_no }}"><i title="edit" class="fa fa-edit" aria-hidden="true"></i></a>
                            <a <?php echo $data->form_sts_desc=='1-Approve' || $data->form_sts_desc=='4-Procurement'?" style='display:none;' ":"";?> onclick="return confirm('Yakin Approve data ?');" href="{{ URL::to('/') }}/admin-user/approve-produksi/{{ $data->routingslip_no }}"><i title="approve" class="fa fa-check-square" aria-hidden="true"></i></a>
