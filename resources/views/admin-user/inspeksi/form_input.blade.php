...
<div class="tab-content" id="myTabContent">
    <div class="tab-pane fade active in" role="tabpanel" id="home" aria-labelledby="home-tab">
            ...
            <div class="form-group row">
                <label  for="inputName" class="col-sm-4 col-form-label text-left"><input value="1"  type="checkbox" <?php echo $row==""?"":($row->ref_api_sts==1?"checked":"") ?> name="ref_api_sts">  API </label>
                <div class="col-sm-6">
                    <input type="text" maxlength="400" class="form-control" id="nama_kelas" name="ref_api_ket" value="{{ $row==""?"":$row->ref_api_ket }}" data-error="tess"  placeholder="keterangan"   >
                </div>
            </div>
            <div class="form-group row">
                ...
                <div class="col-md-6 col-xs-12">
                        ...
                        <a target="blank" href="{{ URL::to('/') }}{{ $row->api_filename }}" ><i style="font-size:20px;" class="fa fa-image"></i> {{ $row->api_filename }}</a>
                            <br><input type="file" name="api_filename"  />
                        @else
            ...
            <div class="form-group row">
                <label  for="inputName" class="col-sm-4 col-form-label text-left"><input value="1"  type="checkbox" <?php echo $row==""?"":($row->ref_astm_sts==1?"checked":"") ?> name="ref_astm_sts">  ASTM </label>
                <div class="col-sm-6">
                    <input type="text" maxlength="400" class="form-control" id="nama_kelas" name="ref_astm_ket" value="{{ $row==""?"":$row->ref_astm_ket }}" data-error="tess"  placeholder="keterangan"   >
                </div>
            </div>
            <div class="form-group row">
                {{-- <div class="col-md-4"></div> --}}
                ...
                <div class="col-md-6 col-xs-12">
                        ...
                        <a target="blank" href="{{ URL::to('/') }}{{ $row->astm_filename }}" ><i style="font-size:20px;" class="fa fa-image"></i> {{ $row->astm_filename }}</a>
                            <br><input type="file" name="astm_filename"  />
                        @else
            ...
            <div class="form-group row">
                <label  for="inputName" class="col-sm-4 col-form-label text-left"><input value="1"  type="checkbox" <?php echo $row==""?"":($row->ref_aws_sts==1?"checked":"") ?> name="ref_aws_sts">  AWS </label>
                <div class="col-sm-6">
                    <input type="text" maxlength="400" class="form-control" id="nama_kelas" name="ref_aws_ket" value="{{ $row==""?"":$row->ref_aws_ket }}" data-error="tess"  placeholder="keterangan"   >
                </div>
            </div>
            <div class="form-group row">
                {{-- <div class="col-md-4"></div> --}}
                ...
                <div class="col-md-6 col-xs-12">
                        ...
                        <a target="blank" href="{{ URL::to('/') }}{{ $row->aws_filename }}" ><i style="font-size:20px;" class="fa fa-image"></i> {{ $row->aws_filename }}</a>
                            <br><input type="file" name="aws_filename"  />
                        @else
            ...
            <div class="form-group row">
                <label  for="inputName" class="col-sm-4 col-form-label text-left"><input value="1"  type="checkbox" <?php echo $row==""?"":($row->ref_tko_sts==1?"checked":"") ?> name="ref_tko_sts">  TKO </label>
                <div class="col-sm-6">
                    <input type="text" maxlength="400" class="form-control" id="nama_kelas" name="ref_tko_ket" value="{{ $row==""?"":$row->ref_tko_ket }}" data-error="tess"  placeholder="keterangan"   >
                </div>
            </div>
            <div class="form-group row">
                {{-- <div class="col-md-4"></div> --}}
                ...
                <div class="col-md-6 col-xs-12">
                        ...
                        <a target="blank" href="{{ URL::to('/') }}{{ $row->tko_filename }}" ><i style="font-size:20px;" class="fa fa-image"></i> {{ $row->tko_filename }}</a>
                            <br><input type="file" name="tko_filename"  />
                        @else
            ...
            <div class="form-group row">
                <label  for="inputName" class="col-sm-4 col-form-label text-left"><input value="1"  type="checkbox" <?php echo $row==""?"":($row->ref_tki_sts==1?"checked":"") ?> name="ref_tki_sts">  TKI </label>
                <div class="col-sm-6">
                    <input type="text" maxlength="400" class="form-control" id="nama_kelas" name="ref_tki_ket" value="{{ $row==""?"":$row->ref_tki_ket }}" data-error="tess"  placeholder="keterangan"   >
                </div>
            </div>
            <div class="form-group row">
                {{-- <div class="col-md-4"></div> --}}
                ...
                <div class="col-md-6 col-xs-12">
                        ...
                        <a target="blank" href="{{ URL::to('/') }}{{ $row->tki_filename }}" ><i style="font-size:20px;" class="fa fa-image"></i> {{ $row->tki_filename }}</a>
                            <br><input type="file" name="tki_filename"  />
                        @else
            ...
            <div class="form-group row">
                <label  for="inputName" class="col-sm-4 col-form-label text-left"><input value="1"  type="checkbox" <?php echo $row==""?"":($row->ref_manualbook_sts==1?"checked":"") ?> name="ref_manualbook_sts">  Manual Book </label>
                <div class="col-sm-6">
                    <input type="text" maxlength="400" class="form-control" id="nama_kelas" name="ref_manualbook_ket" value="{{ $row==""?"":$row->ref_manualbook_ket }}" data-error="tess"  placeholder="keterangan"   >
                </div>
            </div>
            <div class="form-group row">
                <label  for="inputName" class="col-sm-4 col-form-label text-left"><input value="1"  type="checkbox" <?php echo $row==""?"":($row->ref_lain2_sts==1?"checked":"") ?> name="ref_lain2_sts">  Lain-lain </label>
                <div class="col-sm-6">
                    <input type="text" maxlength="400" class="form-control" id="nama_kelas" name="ref_lain2_ket" value="{{ $row==""?"":$row->ref_lain2_ket }}" data-error="tess"  placeholder="keterangan"   >
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-6">
                    <textarea class="form-control" id="nama_kelas" name="rencana_perbaikan" >{{ $row==""?"":$row->rencana_perbaikan }}</textarea>
                </div>
            </div>
                        ...
                        <thead>
                                ...
                                <tr>
                                    <td><div class="autocomplete" style="width:300px;">
                                            <input type="text" size="18" id="m<?php echo $material->baris_no;?>" value="<?php echo $material->keterangan;?>" name="nama[]" onkeypress="jscaridt(this);" >
                                            </div>
                                       </td>
                                       <td><input type="hidden" value="1" size="2" name="jns[]" id="m<?php echo $material->baris_no;?>_jns">
                                           <input type="text" size="2"  onblur="jshitung(this);" name="pn[]"  value="<?php echo $material->keterangan_tambahan;?>" id="m<?php echo $material->baris_no;?>_pn"></td> 
                                       <td><input type="text" size="2" onkeypress="validate(event);" id="m<?php echo $material->baris_no;?>_qty" name="qty[]" value="<?php echo $material->estimasi_jumlah;?>"  onblur="jshitung(this);"></td> 
                                        <td><input type="text" size="2" name="satuan[]" value="<?php echo $material->satuan;?>"  id="m<?php echo $material->baris_no;?>_satuan" onblur="jshitung(this);">
                                        ...
                                        <td><input type="text" size="2" readonly id="m<?php echo $material->baris_no;?>_total" value="<?php echo $material->estimasi_harga_total;?>"  name="total[]"> 
                                            <i onclick="jsdel(this);" id="m<?php echo $material->baris_no;?>_del" class="fa fa-trash"></i></td>
...
//            
        ...
        function jsadd(x,jns){
            ...
            if(jns==1){
                n=$('#'+x+' tr').length;
                $('#'+x+' tr:last').after('<tr><td><div class="autocomplete" style="width:300px;"><input type="text" name="nama[]" size="18" id="m'+n+'"  onkeypress="jscaridt(this);" ></div></td><td><input type="hidden" value="1" size="2" name="jns[]" id="m'+n+'_jns"><input onblur="jshitung(this);" type="text" name="pn[]" size="2" id="m'+n+'_pn"></td><td><input type="text" onkeypress="validate(event);" name="qty[]" size="2" id="m'+n+'_qty" onblur="jshitung(this);"></td><td><input type="hidden" name="id[]" size="2" readonly id="m'+n+'_id"><input onblur="jshitung(this);" type="text" name="satuan[]" size="2"  id="m'+n+'_satuan"></td><td><input type="text" size="2" onblur="jshitung(this);" name="harga[]" id="m'+n+'_harga"></td><td><input type="text" size="2" name="total[]" readonly id="m'+n+'_total">  <i onclick="jsdel(this);" id="m'+n+'_del" class="fa fa-trash"></i></td></tr>');
            }
            if(jns==2){
                n=$('#'+x+' tr').length;
                $('#'+x+' tr:last').after('<tr><td><div class="autocomplete" style="width:300px;"><input type="text" name="tnama[]" size="18" id="t'+n+'"  onkeypress="jscaridt(this);" ></div></td><td><input type="hidden" value="2" size="2" name="tjns[]" id="t'+n+'_jns"><input onblur="jshitung(this);" type="text" name="tpn[]" size="2" id="t'+n+'_pn"></td><td><input type="text" onkeypress="validate(event);" name="tqty[]" size="2" id="t'+n+'_qty" onblur="jshitung(this);"></td><td><input type="hidden" name="tid[]" size="2" readonly id="t'+n+'_id"><input onblur="jshitung(this);" type="text" name="tsatuan[]" size="2" id="t'+n+'_satuan"></td><td><input type="text" onblur="jshitung(this);" size="2" name="tharga[]" id="t'+n+'_harga"></td><td><input type="text" size="2" name="ttotal[]" readonly id="t'+n+'_total">  <i onclick="jsdel(this);" id="t'+n+'_del" class="fa fa-trash"></i></td></tr>');
            }
            if(jns==3){
                n=$('#'+x+' tr').length;
                $('#'+x+' tr:last').after('<tr><td><div class="autocomplete" style="width:300px;"><input type="text" name="pnama[]" size="18" id="p'+n+'"  onkeypress="jscaridt(this);" ></div></td><td><input type="hidden" value="3" size="2" name="pjns[]" id="p'+n+'_jns"><input onblur="jshitung(this);" type="text" name="ppn[]" size="10" id="p'+n+'_pn"></td><td><input type="text" onkeypress="validate(event);" name="pqty[]" size="2" id="p'+n+'_qty" onblur="jshitung(this);"></td><td><input type="hidden" name="pid[]" size="2" readonly id="p'+n+'_id"><input onblur="jshitung(this);" type="text" name="psatuan[]" size="2"  id="p'+n+'_satuan"></td><td><input type="text" onblur="jshitung(this);" size="2" name="pharga[]" id="p'+n+'_harga"></td><td><input type="text" size="2" name="ptotal[]" readonly id="p'+n+'_total">  <i onclick="jsdel(this);" id="p'+n+'_del" class="fa fa-trash"></i></td></tr>');
            }
            if(jns==4){
                n=$('#'+x+' tr').length;
                $('#'+x+' tr:last').after('<tr><td><div class="autocomplete" style="width:300px;"><input type="text" name="rnama[]" size="18" id="r'+n+'"  onkeypress="jscaridt(this);" ></div></td><td><input type="hidden" value="4" size="2" name="rjns[]" id="r'+n+'_jns"><input onblur="jshitung(this);" type="text" name="rpn[]" size="2" id="r'+n+'_pn"></td><td><input type="text" onkeypress="validate(event);" name="rqty[]" size="2" id="r'+n+'_qty" onblur="jshitung(this);"></td><td><input type="hidden" name="rid[]" size="2" readonly id="r'+n+'_id"><input onblur="jshitung(this);" type="text" name="rsatuan[]" size="2"  id="r'+n+'_satuan"></td><td><input type="text" onblur="jshitung(this);" size="2" name="rharga[]" id="r'+n+'_harga"></td><td><input type="text" size="2" name="rtotal[]" readonly id="r'+n+'_total">  <i onclick="jsdel(this);" id="r'+n+'_del" class="fa fa-trash"></i></td></tr>');
            }
            if(jns==6){
                n=$('#'+x+' tr').length;
        ...
        function jshitung(id){
            ...
            param['satuan']=$('#'+x[0]+'_satuan').val();
            param['jenis']=$('#'+x[0]+'_jns').val();
            param['routingslip_no']='{{ $row->routingslip_no }}';
            //jstotal();
            ...
            $.post("{{ URL::to('/') }}/admin-user/detail-material", param,function(data){
                ...
                if($('#'+$(id).attr('id')+'_jns').val()!=5){
                    if($('#'+$(id).attr('id')+'_jns').val()==3){
                        ...
                        $('#'+$(id).attr('id')+'_qty').val(arr[4]);
                        $('#'+$(id).attr('id')+'_total').val(arr[5]);
                    }else{
                        $('#'+$(id).attr('id')+'_harga').val(arr[0]);
                        $('#'+$(id).attr('id')+'_satuan').val(arr[1]);
                        $('#'+$(id).attr('id')+'_id').val(arr[2]);
                        
                        $('#'+$(id).attr('id')+'_qty').val(arr[3]);
                        $('#'+$(id).attr('id')+'_total').val(arr[4]);
                        
                        
                        
                    }
                    $('#'+$(id).attr('id')+'_qty').focus();
                }else{
                    $('#wo').val(arr[0]);
                    $('#register').val(arr[1]);
                    $('#user').val(arr[2]);
    ...
    <div class="tab-pane fade" role="tabpanel" id="profile2" aria-labelledby="profile-tab2">
        ...
        <br><br><table class="table table-bordered" id="tools">        
                            ...
                            ?>
                                <tr>
                                    <td><div class="autocomplete" style="width:300px;">
                                            <input type="text" size="18" id="t<?php echo $tools->baris_no;?>" value="<?php echo $tools->keterangan;?>" name="tnama[]"  onkeypress="jscaridt(this);" >
                                            </div>
                                       </td>
                                       <td><input type="hidden" value="2" size="2" name="tjns[]" id="t<?php echo $tools->baris_no;?>_jns">
                                           <input type="text" size="2"  onblur="jshitung(this);" name="tpn[]"  value="<?php echo $tools->keterangan_tambahan;?>" id="t<?php echo $tools->baris_no;?>_pn"></td> 
                                       <td><input type="text" size="2" onkeypress="validate(event);" id="t<?php echo $tools->baris_no;?>_qty"  value="<?php echo $tools->estimasi_jumlah;?>" name="tqty[]" onblur="jshitung(this);"></td> 
                                        <td><input type="text" size="2"  name="tsatuan[]"  value="<?php echo $tools->satuan;?>" id="t<?php echo $tools->baris_no;?>_satuan">
                                        ...
                                        <td><input type="text" size="2" readonly   value="<?php echo $tools->estimasi_harga_total;?>" id="t<?php echo $tools->baris_no;?>_total" name="ttotal[]"> 
                                            <i onclick="jsdel(this);"  id="t<?php echo $tools->baris_no;?>_del" class="fa fa-trash"></i></td>
    ...
    <div class="tab-pane fade" role="tabpanel" id="profile3" aria-labelledby="profile-tab3">
        ...
        <br><br><table class="table table-bordered" id="personil">        
                                ...
                                <tr>
                                    <td><div class="autocomplete" style="width:300px;">
                                            <input type="text" size="18" id="p<?php echo $personil->baris_no;?>" value="<?php echo $personil->keterangan;?>" name="pnama[]" onkeypress="jscaridt(this);" >
                                            </div>
                                       </td>
                                       <td><input type="hidden" value="3" size="2" name="pjns[]" id="p<?php echo $personil->baris_no;?>_jns">
                                           
                                           <input type="text" onblur="jshitung(this);" size="10" name="ppn[]"  value="<?php echo $personil->keterangan_tambahan;?>" id="p<?php echo $personil->baris_no;?>_pn"></td> 
                                       <td><input type="text" size="2" onkeypress="validate(event);" id="p<?php echo $personil->baris_no;?>_qty" name="pqty[]" value="<?php echo $personil->estimasi_jumlah;?>"  onblur="jshitung(this);"></td> 
                                        <td><input type="text" size="2"  name="psatuan[]" value="<?php echo $personil->satuan;?>"  id="p<?php echo $personil->baris_no;?>_satuan">
                                        ...
                                        <td><input type="text" size="2" readonly id="p<?php echo $personil->baris_no;?>_total" value="<?php echo $personil->estimasi_harga_total;?>"  name="ptotal[]"> 
                                            <i onclick="jsdel(this);" <?php echo $personil->baris_no;?> id="p<?php echo $personil->baris_no;?>_del" class="fa fa-trash"></i></td>
    ...
    <div class="tab-pane fade" role="tabpanel" id="profile4" aria-labelledby="profile-tab4">
        ...
        <br><br><table class="table table-bordered" id="mesin">        
                                ...
                                <tr>
                                    <td><div class="autocomplete" style="width:300px;">
                                            <input type="text" size="18" id="r<?php echo $mesin->baris_no;?>" value="<?php echo $mesin->keterangan;?>" name="rnama[]" onkeypress="jscaridt(this);" >
                                            </div>
                                       </td>
                                       <td><input type="hidden" value="4" size="2" name="rjns[]" id="r<?php echo $mesin->baris_no;?>_jns">
                                           <input type="text" onblur="jshitung(this);" size="2" name="rpn[]"  value="<?php echo $mesin->keterangan_tambahan;?>" id="r<?php echo $mesin->baris_no;?>_pn"></td> 
                                       <td><input type="text" size="2" id="r<?php echo $mesin->baris_no;?>_qty" name="rqty[]" value="<?php echo $mesin->estimasi_jumlah;?>"  onblur="jshitung(this);"></td> 
                                        <td><input type="text" size="2"  name="rsatuan[]" value="<?php echo $mesin->satuan;?>"  id="r<?php echo $mesin->baris_no;?>_satuan">
                                        ...
                                        <td><input type="text" size="2" readonly id="r<?php echo $mesin->baris_no;?>_total" value="<?php echo $mesin->estimasi_harga_total;?>"  name="rtotal[]"> 
                                            <i onclick="jsdel(this);" <?php echo $tools->baris_no;?> id="r<?php echo $mesin->baris_no;?>_del" class="fa fa-trash"></i></td>
                            ...
                            ?>
                                <tr>
                                    <td width="50" height="30">
                                        ...
                                        if($gambar->visual!=""){
                                        ?>
                                        <a target="blank" href="{{ URL::to('/') }}{{ $gambar->visual }}" ><i style="font-size:20px;" class="fa fa-image"></i> <?php $gbr=explode("/",$gambar->visual);echo $gbr[7];?></a>
                                        <?php
                                        }
                                        ?>
                                    ...
                                    <td width="50" height="30">
                                        ...
                                        if($gambar->dimensi!=""){
                                        ?>
                                        <a target="blank" href="{{ URL::to('/') }}{{ $gambar->dimensi }}" ><i style="font-size:20px;" class="fa fa-image"></i> <?php $gbr=explode("/",$gambar->dimensi);echo $gbr[7];?></a>
...
<?php
if($row->keteranganopen!=""){
?>
<div class="form-group row">
    <label  for="inputName" class="col-sm-4 col-form-label text-left">Keterangan Open Status</label>
    <div class="col-sm-6">
        <textarea disabled="true" class="form-control" id="keteranganopen" name="keteranganopen"    >{{ $row->keteranganopen }}</textarea>
    </div>
</div>
<?php
}
