...
<div class="tab-content" id="myTabContent">
    <div class="tab-pane fade active in" role="tabpanel" id="home" aria-labelledby="home-tab">
            ...
            <div class="form-group row">
                <label  for="inputName" class="col-sm-4 col-form-label text-left"><input value="1" disabled="true"  type="checkbox" <?php echo $row==""?"":($row->ref_api_sts==1?"checked":"") ?> name="ref_api_sts">  API </label>
                <div class="col-sm-6">
            ...
            <div class="form-group row">
                <label  for="inputName" class="col-sm-4 col-form-label text-left"><input value="1" disabled="true"  type="checkbox" <?php echo $row==""?"":($row->ref_astm_sts==1?"checked":"") ?> name="ref_astm_sts">  ASTM </label>
                <div class="col-sm-6">
            ...
            <div class="form-group row">
                <label  for="inputName" class="col-sm-4 col-form-label text-left"><input value="1" disabled="true"  type="checkbox" <?php echo $row==""?"":($row->ref_tki_sts==1?"checked":"") ?> name="ref_tki_sts">  TKI </label>
                <div class="col-sm-6">
            ...
            <div class="form-group row">
                <label  for="inputName" class="col-sm-4 col-form-label text-left"><input value="1" disabled="true"  type="checkbox" <?php echo $row==""?"":($row->ref_manualbook_sts==1?"checked":"") ?> name="ref_manualbook_sts">  Manual Book </label>
                <div class="col-sm-6">
            ...
            <div class="form-group row">
                <label  for="inputName" class="col-sm-4 col-form-label text-left"><input value="1" disabled="true"  type="checkbox" <?php echo $row==""?"":($row->ref_lain2_sts==1?"checked":"") ?> name="ref_lain2_sts">  Lain-lain </label>
                <div class="col-sm-6">
