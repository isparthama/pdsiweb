        ...
        (function() {
            $('.form1').ajaxForm({
                ...
                complete: function(xhr) {
                    ...
                    window.open('{{ URL::to('/') }}/admin-user/tools-list/','_self');
...
<form id="form1" enctype="multipart/form-data"  class="form1" method="post" action="{{ $row==""?URL::to('/').'/admin-user/tools-store':URL::to('/').'/admin-user/tools-update' }}">
    {{ csrf_field() }}
...
<div class="form-group">
    ...
    <button type="button" onclick="window.open('/admin-user/tools-list','_self')" class="btn btn-primary waves-effect waves-light" ><i class="fa fa-rotate-left" aria-hidden="true"></i></button>
