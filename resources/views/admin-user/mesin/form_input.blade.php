        ...
        (function() {
            $('.form1').ajaxForm({
                ...
                complete: function(xhr) {
                    ...
                    window.open('{{ URL::to('/') }}/admin-user/mesin-list/','_self');
...
<form id="form1" enctype="multipart/form-data"  class="form1" method="post" action="{{ $row==""?URL::to('/').'/admin-user/mesin-store':URL::to('/').'/admin-user/mesin-update' }}">
    {{ csrf_field() }}
<ul class="nav nav-tabs" id="myTabs" role="tablist">
            <li role="presentation" class="active"><a href="#home" id="home-tab" role="tab" data-toggle="tab" aria-controls="home" aria-expanded="true">Mesin</a></li>
...
<div class="form-group">
    ...
    <button type="button" onclick="window.open('/admin-user/mesin-list','_self')" class="btn btn-primary waves-effect waves-light" ><i class="fa fa-rotate-left" aria-hidden="true"></i></button>
